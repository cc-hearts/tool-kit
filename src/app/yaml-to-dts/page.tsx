...
export default function useYamlToDts() {
    ...
    return <div className="flex gap-4 h-dvh w-full items-center justify-center p-6">
        <textarea className="w-full h-full" value={yamlCtx} onChange={(e) => setYamlCtx(e.currentTarget.value)} />
